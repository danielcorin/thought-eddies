...
The results were pretty reasonable for such a <Sidenote anchor="small model" content="Small models love to ignore directions about output formatting and will frequently add content like 'Here's the updated document:' even when you explicitly prompt them not to." />.

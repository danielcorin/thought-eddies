...
<Tweet theme="dark" id="https://twitter.com/dadkins_/status/1815048314439532685" />
...
<Chat
  ...
  messages={[
    ...
    {
      role: "assistant",
      content: "I'm based on the GPT-3 architecture, which is a transformer-based model. The transformer architecture employs mechanisms like self-attention and feedforward neural networks to process and generate text. If you have specific questions about the architecture or how it works, feel free to ask!"
    },
    {
      role: "user",
    ...
    {
      role: "assistant",
      content: "My knowledge cutoff date is October 2021. This means I have information and data available up to that point, but I don't have access to events or developments that occurred after that date. If you have questions about anything up to that time, feel free to ask!"
    }
  ]}
/>

...
createdAt: 2025-01-16T21:08:37-05:00
updatedAt: 2025-01-16T21:08:37-05:00
...
export const messages = [
    ...
    },
    {
        ...
        summary: "Introduction to neural networks as brain-inspired computing systems"
    },
    {
        id: "3",
        parent_id: "1",
        prompt: "What about reinforcement learning?",
        response: "Reinforcement learning is learning through interaction with an environment",
    ...
    },
    {
        ...
        response: "Common applications include image recognition and natural language processing",
        summary: "Real-world applications of neural networks in computer vision and NLP"
    },
    {
        id: "5",
        parent_id: "3",
        prompt: "What are some examples?",
        response: "Examples include game playing AIs like AlphaGo and robotics control",
        summary: "Concrete examples of reinforcement learning in games and robotics"
    }
]
...
export const moreMessages = [
    ...
    },
    {
        ...
        response: "Key ethical concerns include bias in training data, privacy issues, and potential job displacement",
    ...
    },
    {
        ...
        response: "ML is used for disease diagnosis, drug discovery, and personalized treatment plans",
    ...
    },
    {
        ...
        response: "Popular languages include Python, R, and Julia with frameworks like TensorFlow and PyTorch",
    ...
    },
    {
        ...
        response: "Through diverse training data, regular audits, and transparent model development processes",
    ...
    },
    {
        ...
        response: "ML assists in analyzing medical images to detect tumors, fractures, and other abnormalities",
    ...
    },
    {
        ...
        response: "PyTorch is a deep learning framework developed by Facebook, known for its dynamic computational graphs",
    ...
    },
    {
        ...
        response: "Julia offers better performance and mathematical syntax, but has a smaller ecosystem than Python",
    ...
    },
    {
        ...
        response: "ML medical tools require rigorous validation and regulatory approval processes",
    ...
    },
    {
        ...
        response: "PyTorch is more pythonic and flexible, while TensorFlow has better production tools",
...
<Alert type="tip" mobileOnly>
  The interactive visuals in the post don't play so nice on small devices.
  You can still enjoy on your phone but be sure to check them out later on a bigger screen.
</Alert>

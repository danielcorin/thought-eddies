---
title: "Find the Groove: Using Checkpoints with Coding Agents"
createdAt: 2025-07-24T20:35:04.630040
updatedAt: 2025-07-24T20:35:04.630040
description: "Checkpointing is the current moat between IDE and CLI-based coding assistants."
location: "NYC"
draft: false
...
Cursor was my first experience with the UX pattern of checkpoints when working with a coding agent.
...
For non-engineers, editing a code project is like editing 10s of text documents simultaneously and the undo hotkey doesn't work.
They send a prompt and a ton of stuff happens.
...
When verification fails they must go back to the last prior working state.
This is where checkpoints are critical.

The ability to revert to the state to "what was working right before I did that last thing" is the fundamental loop that makes creating software as a non-engineer possible.
...
Agents are relatively good at finding the relevant files in a codebase that needed editing to implement instructions described in a prompt but they don't always get this right.

...
atUri: 'at://did:plc:mracrip6qu3vw46nbewg44sm/site.standard.document/3mhnqy3nnr62f'
---
...
The goal is to find a groove[^1] with the agent.
...
[^1]: Like a physical groove in wood or a vinyl record. But also like a musical groove where you _feel_ aligned with the rhythm. It's called 'vibe coding' for a reason. There is as much art to this as there is science.

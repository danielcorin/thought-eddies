...
1. Write your markdown content normally in the `.mdx` file
2. Generate zoom levels using a language model with the raw post as context
3. Save each zoom level as a separate markdown file in the same directory
4. Import the zoom levels into your MDX file:
...
5. Wrap your content in the `ZoomableDocument` component with the levels prop

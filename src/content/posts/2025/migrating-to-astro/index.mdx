...
Hugo (the static site generator I used to build my [previous site](https://github.com/danielcorin/blog)) claims to be fast and there is much discussion about how the Javascript web (and Astro by proxy) can be slow and bloated, but was it really this bad?

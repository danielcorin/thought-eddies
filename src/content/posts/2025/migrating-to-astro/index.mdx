...
At build time, a webserver starts and a process requests the content, then persists it as a static HTML file to be served in production.

No API calls.

What was taking so long?

I pulled it down and started to look around

...
- [claude-4.7-opus](https://docs.anthropic.com/en/docs/about-claude/models/overview)
...
- Switch from Waterfox to Helium
- Now splitting use between Claude Codex and Codex
- Running a Pi-based stateful agent in addition to a claude-agent-sdk based one
- Rename "Language Models" section to "AI things"
- Bump claude-4.6-opus to claude-4.7-opus, add gpt-5.5

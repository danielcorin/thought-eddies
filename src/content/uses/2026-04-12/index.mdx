...
- Drop Element, Obsidian, and Tomo from macOS apps
- Add Handy for local voice to text
- Experimenting with Ghostty
- Replace `llm` and `hugo` with `astro` in CLI; drop `ollama`
- Swap experimental editors/launchers (Zed, WezTerm, Raycast) for `hermes`
- Drop Obsidian from iOS
- Update language model to claude-4.6-opus
